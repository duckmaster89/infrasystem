...
urlpatterns = [
    ...
    path('status-equipo/create/', views.create_status_equipo, name='create_status_equipo'),
    path('status-equipo/', views.list_status_equipo, name='list_status_equipo'),
    path('status-equipo/<int:statuse_id>/edit/', views.edit_status_equipo, name='edit_status_equipo'),
    path('status-equipo/<int:statuse_id>/delete/', views.delete_status_equipo, name='delete_status_equipo'),
] 